...
function PaginationSection({
  ...
  const renderPages = () => {
    const renderedPages = activePages.map((page, idx) => (
      ...
      >
        <PaginationLink onClick={() => setCurrentPage(page)} size={undefined}>
          {page}
        </PaginationLink>
      </PaginationItem>
    ));
        ...
        <PaginationContent>
          <PaginationItem>
            <PaginationPreviousLast
              ...
              size={undefined}
            />
            <PaginationPrevious onClick={handlePrevPage} size={undefined} />
          </PaginationItem>

          {renderPages()}

          <PaginationItem>
            <PaginationNext onClick={handleNextPage} size={undefined} />
            <PaginationNextLast onClick={handleNextPageLast} size={undefined} />
          </PaginationItem>
        </PaginationContent>
      </Pagination>
    </div>
